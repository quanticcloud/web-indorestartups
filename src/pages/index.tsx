...
const IndexPage = () => {
  return (
    <Layout>
      <main>
        <title>Welcome to Indore Startups</title>
              ...
              <div data-w-id="fee6c11f-454d-a31b-c936-e96f978ddd39" className="v3-1-hero w-container">
                  ...
                  <div className="home-announcement-container">
                      ...
                      <a data-event-category="Home Announcement Link" data-event-action="Click" data-event-label="Roast My Finance Stack"
                         href="https://dd.zone/roast-my-finance-stack" className="v3-banner-link w-inline-block">
                  ...
                  <h1 id="v3-hero-heading-original" className="v3-1-hero-heading">Put startups on autopilot<br/></h1>
                  <div className="v3-1-hero-text">
                  For founders and startups teams of all sizes.
                  </div>
...
{/*
                      <div className="div-block-80">
                          <a data-event-action="Click" data-event-category="Sign Up" data-event-label="Home Hero Module"
                             href="" className="v3-1-btn-get-started v3-1-btn-get-started-large w-button"><strong
                              className="bold-text-21">Create your account</strong></a>
                          <a data-event-category="Demo booking" data-event-action="Click"
                             data-event-label="Hero - Book a demo" href=""
              ...
              <div className="v3-1-book-demo-container w-container">
                  <div className="div-block-81">
                      ...
                      <div className="text-block-65">
                          ...
                          <b>Area of expertise: </b><br/>
                          <ul>
                              <li>Marketing and manufacturing Herbal products</li>
                          </ul>
                      </div>
                  </div>
              </div>
                  ...
                  <div className="div-block-81">
                      ...
                      <div>
                          <video controls autoPlay className="image-72">
                              <source src="https://techymau.games/assets/images/techymau-vid_1.mp4" type="video/mp4"/>
